...
namespace P4EXP
{
    [Guid("E0CCCD7D-DB3D-4AF7-803C-14314415EB7B"), ComVisible(true)]
    ...
    public class P4EXPColumnExtension1 : PropertyHandler
    {
        public P4EXPColumnExtension1()
        {
        }
        ...
        {
            PropertyHandler.RegisterExtension(typeof(P4EXPColumnExtension1));
        }

        [ComUnregisterFunction]
        public static void UnRegister(System.Type t)
        {
            PropertyHandler.UnRegisterExtension(typeof(P4EXPColumnExtension1));
        }
