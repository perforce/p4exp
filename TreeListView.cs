...
namespace P4EXP
{
	public class TreeListView : ListView
	{
        ...
        protected override void OnNotifyMessage(System.Windows.Forms.Message message)
        {
											...
											TreeListViewItem item)
		{
			...
			{
				FileLogger.LogException(Properties.Resources.FileLogger_TreeListView_EnsureVisible, ex);
			}
		}
